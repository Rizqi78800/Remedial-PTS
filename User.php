...
class User extends UserAbstract implements UserInterface {
    ...
    public static function index(){
        $result = DB::connect("SELECT * FROM users")->fetch_all(MYSQLI_ASSOC); 
        return $result;
    }
    ...
    public static function create(){
        ...
        $result = DB::connect("INSERT INTO users (username, password) VALUES ('$username', '$password')");
        return $result;
    }
    
    public static function show($id){
        $result = DB::connect("SELECT*FROM users WHERE id= '$id'")->fetch_assoc(); 
        return $result;
    }
    ...
    public static function delete($id){
        $result = DB::connect("DELETE FROM users WHERE id='$id'"); 
